        ...
        <div className="grid md:grid-cols-3 gap-8">
          {doctors.map((d, i) => (
            <motion.div key={i} initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ delay: i * 0.15 }}
              ...
              <div className="h-48 flex items-center justify-center" style={{background: 'linear-gradient(135deg, #f0f9ff 0%, #e0f2fe 50%, #0ea5e9 100%)'}}>
              ...
              <div className="p-6">
                ...
                <p className="text-sm font-medium mb-2" style={{color: '#0ea5e9'}}>{d.specialty}</p>
